...
EXEC sp_rename [Kunde], [Kunde_1];
EXEC sp_rename [Wohnort], [Wohnort_1];
EXEC sp_rename [Lieferadresse], [Lieferadresse_1];
EXEC sp_rename [VereinsPartner], [VereinsPartner_1];
EXEC sp_rename [Kategorie], [Kategorie_1];
EXEC sp_rename [Produkt], [Produkt_1];
EXEC sp_rename [Bestellung], [Bestellung_1];
EXEC sp_rename [Position], [Position_1];
EXEC sp_rename [Lieferung], [Lieferung_1];
EXEC sp_rename [LieferDienst], [LieferDienst_1];
