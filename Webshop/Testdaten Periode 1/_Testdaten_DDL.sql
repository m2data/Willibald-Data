...
ALTER TABLE [Wohnort] WITH CHECK ADD CONSTRAINT [FK_Wohnort_KundeID] FOREIGN KEY([KundeID])
REFERENCES [Kunde] ([KundeID])

ALTER TABLE [Wohnort] CHECK CONSTRAINT [FK_Wohnort_KundeID]

ALTER TABLE [Lieferadresse] WITH CHECK ADD CONSTRAINT [FK_Lieferadresse_KundeID] FOREIGN KEY([KundeID])
REFERENCES [Kunde] ([KundeID])

ALTER TABLE [Lieferadresse] CHECK CONSTRAINT [FK_Lieferadresse_KundeID]
...
ALTER TABLE [Kategorie] WITH CHECK ADD CONSTRAINT [FK_Kategorie_OberKatID] FOREIGN KEY([OberKatID])
REFERENCES [Kategorie] ([KatID])

ALTER TABLE [Kategorie] CHECK CONSTRAINT [FK_Kategorie_OberKatID]

ALTER TABLE [Produkt] WITH CHECK ADD CONSTRAINT [FK_Produkt_KatID] FOREIGN KEY([KatID])
REFERENCES [Kategorie] ([KatID])

ALTER TABLE [Produkt] CHECK CONSTRAINT [FK_Produkt_KatID]
...
ALTER TABLE [Bestellung] WITH CHECK ADD CONSTRAINT [FK_Bestellung_AllgLieferAdrID] FOREIGN KEY([AllgLieferAdrID])
REFERENCES [Lieferadresse] ([LieferAdrID])

ALTER TABLE [Bestellung] CHECK CONSTRAINT [FK_Bestellung_AllgLieferAdrID]

ALTER TABLE [Position] WITH CHECK ADD CONSTRAINT [FK_Position_BestellungID] FOREIGN KEY([BestellungID])
REFERENCES [Bestellung] ([BestellungID])

ALTER TABLE [Position] CHECK CONSTRAINT [FK_Position_BestellungID]

ALTER TABLE [Position] WITH CHECK ADD CONSTRAINT [FK_Position_ProduktID] FOREIGN KEY([ProduktID])
REFERENCES [Produkt] ([ProduktID])

ALTER TABLE [Position] CHECK CONSTRAINT [FK_Position_ProduktID]

ALTER TABLE [Position] WITH CHECK ADD CONSTRAINT [FK_Position_SpezLieferAdrID] FOREIGN KEY([SpezLieferAdrID])
REFERENCES [Lieferadresse] ([LieferAdrID])

ALTER TABLE [Position] CHECK CONSTRAINT [FK_Position_SpezLieferAdrID]

ALTER TABLE [Lieferung] WITH CHECK ADD CONSTRAINT [FK_Lieferung_BestellungID_PosID] FOREIGN KEY([BestellungID], [PosID])
REFERENCES [Position] ([BestellungID], [PosID])

ALTER TABLE [Lieferung] CHECK CONSTRAINT [FK_Lieferung_BestellungID_PosID]

ALTER TABLE [Lieferung] WITH CHECK ADD CONSTRAINT [FK_Lieferung_LieferAdrID] FOREIGN KEY([LieferAdrID])
REFERENCES [Lieferadresse] ([LieferAdrID])

ALTER TABLE [Lieferung] CHECK CONSTRAINT [FK_Lieferung_LieferAdrID]

ALTER TABLE [Lieferung] WITH CHECK ADD CONSTRAINT [FK_Lieferung_LieferDienstID] FOREIGN KEY([LieferDienstID])
REFERENCES [LieferDienst] ([LieferDienstID])

ALTER TABLE [Lieferung] CHECK CONSTRAINT [FK_Lieferung_LieferDienstID]
